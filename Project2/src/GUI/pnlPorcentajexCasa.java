 ...
 * @author gara8
 */
public class pnlPorcentajexCasa extends javax.swing.JPanel {

    DefaultPieDataset datos = new DefaultPieDataset();
    Consultas consultas = new Consultas();
    
    public pnlPorcentajexCasa() {
        initComponents();
        datos.clear();
        Graficos.listaDatos.clear();
        ArrayList<Graficos> listaDatos = consultas.cargarGraficoPorcentajexCasa();
        ...
        JFreeChart grafico_circular = ChartFactory.createPieChart("Top Porcentual de Super Héroes por Casa de Publicación", datos, true, true, true);
