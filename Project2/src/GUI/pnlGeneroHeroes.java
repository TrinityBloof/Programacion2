 ...
 * @author gara8
 */
public class pnlGeneroHeroes extends javax.swing.JPanel {

    DefaultPieDataset datos = new DefaultPieDataset();
    Consultas consultas = new Consultas();
    
    public pnlGeneroHeroes() {
        initComponents();
        datos.clear();
        Graficos.listaDatos.clear();
        ArrayList<Graficos> listaDatos = consultas.cargarGraficoPorGenero();
        ...
        JFreeChart grafico_circular = ChartFactory.createPieChart("Distribución de Héroes por género", datos, true, true, true);
