 ...
 * @author gara8
 */
public class pnlAlineacionF extends javax.swing.JPanel {

    DefaultPieDataset datos = new DefaultPieDataset();
    Consultas consultas = new Consultas();
    
    public pnlAlineacionF() {
        initComponents();
        datos.clear();
        Graficos.listaDatos.clear();
        ArrayList<Graficos> listaDatos = consultas.cargarGraficoAlineacionF();
        ...
        JFreeChart grafico_circular = ChartFactory.createPieChart("Gráfico por Alineación (Femenino)", datos, true, true, true);
