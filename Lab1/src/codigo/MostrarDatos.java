...
public class MostrarDatos {
    ...
    public void mostrarDatosObjetos(JTable tbMostrar) {
        ...
        for (int i = 0; i < listaHistorial.size(); i++) {
            ...
            arreglo[1] = listaHistorial.get(i).getEspaciosLimpios();
            arreglo[2] = listaHistorial.get(i).getEspaciosSucios();
            arreglo[3] = listaHistorial.get(i).getEspaciosObstaculos();
            arreglo[4] = listaHistorial.get(i).getPosicionesRecorridas();
            arreglo[5] = listaHistorial.get(i).getPosicionesLimpias();
            arreglo[6] = listaHistorial.get(i).getSuciudadFaltante();
